...
namespace HomeWork_1
{
    class Program
    {
        ...
        public static void Update()
        {
            ...
            User u = new User
            {
                Name = "我与春风皆过客12111111111111112111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111",
                Account = "Account111111111111111111111111111111121111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111",
                Password = "Password1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111",
                Email = "530216775@qq.com",
                Mobile = "15007140962",
                CreatorId = 21,
                CompanyName = "公司11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111112",
                CompanyId = 2111,
                State = 11111,
                UserType = 21111,
                LastLoginTime = DateTime.Now,
